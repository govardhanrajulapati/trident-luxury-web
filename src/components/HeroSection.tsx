    ...
    <section className="relative h-screen overflow-hidden">
          ...
          <div className="max-w-3xl">
            <div className="animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                ...
                <Button 
                  variant="outline" 
                  className="border-2 border-white text-white hover:bg-white hover:text-navy-900 text-lg px-8 py-4 transition-all duration-300"
                >
              ...
              <div className="flex flex-wrap gap-8">
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-gold-400 font-playfair">25+</div>
                  <div className="text-white/80">Projects Completed</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-gold-400 font-playfair">1000+</div>
                  <div className="text-white/80">Happy Families</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl md:text-4xl font-bold text-gold-400 font-playfair">15+</div>
      ...
      <div className="absolute top-1/2 right-8 transform -translate-y-1/2 z-20 hidden lg:block">
        <Button
          variant="outline"
          size="icon"
          className="w-16 h-16 rounded-full border-2 border-white/50 text-white hover:bg-white hover:text-navy-900 transition-all duration-300"
        >
