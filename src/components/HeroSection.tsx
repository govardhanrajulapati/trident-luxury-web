            ...
            <div className="max-w-4xl order-2 xl:order-1">
              <div className="animate-fade-in">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8 md:mb-12">
                  ...
                  <Button 
                    variant="outline" 
                    className="border-2 border-white/80 text-white hover:bg-white hover:text-navy-900 text-base md:text-lg px-6 md:px-8 py-3 md:py-4 transition-all duration-300 backdrop-blur-sm shadow-xl"
                  >
